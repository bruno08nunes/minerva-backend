...
import { arithmeticChoices, assignmentChoices, logicalChoices, relationalChoices } from "./operators/choices";
import { assignmentLessonChoices, constChoices, dataTypesLessonChoices, firstLessonChoices } from "./variable/choices"
...
export const horrorChoices = [...variableChoices, ...operatorChoices, ...conditionalChoices, ...loopChoices, ...functionChoices, ...arrayChoices, ...objectChoices];